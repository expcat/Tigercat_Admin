...
| 审批 Mock | [api/approvals.md](api/approvals.md) | `/api/approvals`、四条列表车道、动作写回实例（可选同步工单状态） |
...
| 动态菜单 schema | [api/menus.md](api/menus.md) | `GET /api/menus/schema`；节点 CRUD `POST/PUT/DELETE /api/menus/nodes` |
